function [specData, prjInfo] = MAT(specData, fileName, ReadType)
    ...
    switch ReadType
        case {'MetaData', 'SingleFile'}
            specData = Fcn_MetaDataReader(specData, fileName);
            prjInfo  = [];
...
%-------------------------------------------------------------------------%
function specData = Fcn_MetaDataReader(specData, fileName)
