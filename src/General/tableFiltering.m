classdef tableFiltering < handle
    ...
    properties (Constant)
        ...
        FILTER_TYPE_MAPPING = dictionary( ...
            ["uint8", "uint16", "uint32", "uint64", "int8", "int16", "int32", "int64", "single", "double", "logical", "char", "string", "cell", "cellstr", "categorical", "datetime"], ...
            [repmat("numeric", 1, 10), "logical", repmat("cellstr", 1, 4), "categorical", "datetime"] ...
        )

        FILTER_SYMBOLS = dictionary( ...
            ["uint8", "uint16", "uint32", "uint64", "int8", "int16", "int32", "int64", "single", "double", "logical", "char", "string", "cell", "cellstr", "categorical", "datetime"], ...
            [repmat("🔢", 1, 10), "🔘", repmat("🔤", 1, 4), "🏷️", "📅"] ...
        )
